...
def main(input_file):
    try:
        with open(input_file) as f:
            ...
            points_sum1 = sum([first_strategy(line) for line in lines])
            points_sum2 = sum([second_strategy(line) for line in lines])
            print('Points earned with first strategy:', points_sum1)
            print('Points earned with second strategy:', points_sum2)
